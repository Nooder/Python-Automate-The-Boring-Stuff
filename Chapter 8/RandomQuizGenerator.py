#! python3
# Chapter 8 Project - Generate random layout of questions in a quiz with random ordering of choices for each question along with the key
...
for quizNum in range(35):
    ...
    # Write out the header file for the quiz
    quizFile.write('Name:\n\nDate:\n\nPeriod:\n\n')
